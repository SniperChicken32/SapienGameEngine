...
#define  RENDER_QUEUE_SKY_EARLY          1
#define  RENDER_QUEUE_SKY                2
#define  RENDER_QUEUE_WORLD_GEOMETRY     3
#define  RENDER_QUEUE_GEOMETRY_EARLY     4
#define  RENDER_QUEUE_GEOMETRY           5
#define  RENDER_QUEUE_GEOMETRY_LATE      6
#define  RENDER_QUEUE_OVERLAY_EARLY      7
#define  RENDER_QUEUE_OVERLAY            8
#define  RENDER_QUEUE_FOREGROUND         9
